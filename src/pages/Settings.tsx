  ...
  return (
    <div className="min-h-screen bg-background px-6 pt-6 pb-8">
      ...
      <div className="space-y-0">
        <div className="flex items-center gap-4 py-5 border-b border-border/30">
          <Palette className="h-4 w-4 text-muted-foreground/40" strokeWidth={1.5} />
          <div className="flex-1">
            <p className="text-sm font-light tracking-wide">Тема</p>
            <p className="text-xs font-light text-muted-foreground/50 mt-0.5 flex items-center gap-1.5">
