...
const basePublications: Publication[] = [
  ...
  },
  {
    ...
    authorId: 'm6',
    coAuthorIds: [],
    title: 'Выпускной в Казанском университете',
    text: 'Наконец-то диплом в руках! Пять лет пролетели незаметно. Спасибо маме за поддержку и терпение — без неё бы не справилась. Теперь впереди новая глава, и я готова к приключениям!',
    eventDate: '2024-06-28',
    place: 'Казань',
    publishDate: '2026-03-17',
    media: [photo(10, 'Фото 3.png', 'Выпускной')],
    participantIds: ['m6', 'm8'],
    topicTag: 'День рождения',
    likes: ['m8', 'm4'],
    comments: [],
    isRead: false,
  },
  {
    ...
    authorId: 'm6',
    coAuthorIds: [],
    title: 'Тбилиси — город, в который влюбляешься с первого взгляда',
    text: 'Путешествие с подругами в Грузию. Старый город, хинкали, вино и бесконечные разговоры до утра. Уже мечтаю вернуться!',
    eventDate: '2024-09-12',
    place: 'Тбилиси',
    publishDate: '2026-03-16',
    media: [photo(11, 'Фото 4.png', 'Тбилиси')],
    participantIds: ['m6'],
    topicTag: 'Путешествия',
    likes: ['m8'],
    comments: [],
  ...
  },
  {
    ...
    authorId: 'm7',
    coAuthorIds: [],
    title: 'Рыбалка с Кириллом на Рыбинке',
    text: 'Выходные на водохранилище. Кирилл впервые поймал щуку — гордость отца! Вечером жарили улов на костре. Такие моменты бесценны.',
    eventDate: '2023-08-19',
    place: 'Рыбинское водохранилище',
    publishDate: '2026-03-15',
    media: [photo(12, 'Фото 4.png', 'Рыбалка')],
    participantIds: ['m7', 'm9'],
    topicTag: 'Путешествия',
    likes: ['m9', 'm3'],
    comments: [],
    isRead: false,
  },
  {
    ...
    authorId: 'm7',
    coAuthorIds: [],
    title: '60 лет отцу — праздник на берегу',
    text: 'Собрали семью в Сочи на юбилей папы. Погода подарила тёплый день, море было спокойным. Папа рассказывал старые истории, мы смеялись до слёз.',
    eventDate: '2024-07-20',
    place: 'Сочи',
    publishDate: '2026-03-14',
    media: [photo(13, 'Фото 5.png', 'Юбилей')],
    participantIds: ['m7', 'm9', 'm1'],
    topicTag: 'День рождения',
    likes: ['m1', 'm3'],
    comments: [],
    isRead: false,
  },
  {
    ...
    text: 'Каждый год 31 декабря — одно и то же: нарезаю овощи, варю яйца, добавляю горошек. Рецепт передала мама, теперь делюсь с Аней. Без этого салата — не Новый год!',
    eventDate: '2024-12-31',
    place: 'Уфа',
    publishDate: '2026-03-13',
    media: [photo(14, 'Фото 6.png', 'Оливье')],
    participantIds: ['m8', 'm6'],
    topicTag: 'Рецепты',
    likes: ['m6', 'm2'],
    comments: [],
    isRead: false,
  },
  {
    ...
    authorId: 'm8',
    coAuthorIds: [],
    title: 'Воскресный обед в кругу семьи',
    text: 'Аня приехала на выходные. Накрыли стол, достали фарфор — как в детстве. Разговоры, смех, планы на лето. Семья — это когда тебя ждут.',
    eventDate: '2024-11-10',
    place: 'Уфа',
    publishDate: '2026-03-12',
    media: [photo(15, 'Фото 1.jpg', 'Семейный обед')],
    participantIds: ['m8', 'm6'],
    topicTag: 'Будни',
    likes: ['m6'],
    comments: [],
  ...
  },
  {
    ...
    authorId: 'm9',
    coAuthorIds: [],
    title: 'Сезон сноуборда открыт',
    text: 'Роза Хутор, первый выезд в этом году. Снег отличный, трассы пустые. Жизнь удалась!',
    eventDate: '2025-01-05',
    place: 'Красная Поляна',
    publishDate: '2026-03-11',
    media: [photo(16, 'Фото 5.png', 'Сноуборд')],
    participantIds: ['m9'],
    topicTag: 'Путешествия',
    likes: ['m7'],
    comments: [],
  ...
  },
  {
    ...
    authorId: 'm9',
    coAuthorIds: [],
    title: 'Сессия закрыта — можно выдохнуть',
    text: 'Три экзамена за неделю. Кофе, конспекты, бессонные ночи. Но всё сдано! Фото для истории — и бегу отмечать с одногруппниками.',
    eventDate: '2024-06-15',
    place: 'Сочи',
    publishDate: '2026-03-10',
    media: [photo(17, 'Фото 2.png', 'После сессии')],
    participantIds: ['m9'],
    topicTag: 'Будни',
    likes: ['m7', 'm6'],
    comments: [],
  ...
  },
  {
    ...
    authorId: 'm10',
    coAuthorIds: [],
    title: 'Школьный бал — первый выход в свет',
    text: 'Выпускной в 4 классе! Платье выбирали с мамой целый месяц. Я так волновалась, но всё прошло идеально. Даже получила грамоту за отличную учёбу!',
    eventDate: '2023-05-25',
    place: 'Вологда',
    publishDate: '2026-03-09',
    media: [photo(18, 'Фото7.png', 'Школьный бал')],
    participantIds: ['m10', 'm8'],
    topicTag: 'Истории',
    likes: ['m8', 'm6'],
    comments: [],
    isRead: false,
  },
  {
    ...
    authorId: 'm10',
    coAuthorIds: [],
    title: 'Каникулы у тёти Светы',
    text: 'Поехала к тёте в Уфу на неделю. Гуляли по городу, пекли пироги, смотрели старые фото. Тётя показала, где она училась — теперь и я хочу туда!',
    eventDate: '2024-08-03',
    place: 'Уфа',
    publishDate: '2026-03-08',
    media: [photo(19, 'Фото 3.png', 'Каникулы')],
    participantIds: ['m10', 'm8'],
    topicTag: 'Путешествия',
    likes: ['m8', 'm6'],
    comments: [],
