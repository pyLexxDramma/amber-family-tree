...
const baseMembers: FamilyMember[] = [
  { id: 'm1', firstName: 'Владимир', lastName: 'Фадеев', middleName: 'Николаевич', nickname: 'Дедушка', birthDate: '1959-01-17', deathDate: '2020-03-15', city: 'Ленинград', about: 'Папа Алины Фадеевой. Любит рыбалку и поездки на природу.', role: 'member', isActive: true, generation: 1, relations: [{ memberId: 'm4', type: 'child' }, { memberId: 'm0a', type: 'parent' }] },
  ...
  { id: 'm6', firstName: 'Анна', lastName: 'Соколова', nickname: 'Аня (тест)', birthDate: '1998-05-22', city: 'Казань', about: 'Двоюродная сестра. Тестовый участник для демонстрации.', role: 'member', isActive: true, generation: 3, relations: [{ memberId: 'm8', type: 'parent' }], avatar: '/prototype/avatars/avatar-test-anna.png', managedById: 'm4' },
