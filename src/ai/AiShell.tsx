...
export const AiShell: React.FC = () => {
        ...
        const applyIntent = (intent: { type: string; entity?: string }) => {
          switch (intent.type) {
            ...
            case 'create_publication':
              ...
              break;
            case 'help':
              if (!reply) reply = 'Я умею: показать дерево, рассказать про любого, показать ленту, галерею, создать публикацию, пригласить родственников. Навигация: «открой настройки», «покажи ленту», «создай публикацию», «пригласи присоединиться», «назад». Скролл: «пролистай вниз/вверх». Тема: «тёмная тема», «светлая тема».';
              break;
            case 'greeting':
  ...
  const WELCOME_SPEECH =
    'Здравствуйте! Я Angelo — помощник вашей семьи. Спросите голосом или напишите, я открою нужную страницу.';
