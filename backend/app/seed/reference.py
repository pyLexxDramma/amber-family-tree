...
PUBLICATIONS = [
    ...
    {
        "title": "Майский Сочи: семейная прогулка",
        "text": "Вышли на набережную с самого утра, пока не жарко. Лёгкий бриз, пальмы и ощущение, что отпуск только начинается.",
    ...
    {
        "title": "Сочи на закате",
        "text": "Вечером пошли к морю и долго сидели на берегу. Лиза сказала, что это её самый спокойный день за весь год.",
    ...
    {
        "title": "Наша гордость: школьный концерт",
        "text": "Сегодня Лиза выступала на школьной сцене. Мы с Ромой волновались больше, чем она.",
    ...
    {
        "title": "Наша гордость: конец четверти",
        "text": "Отметили отличные оценки семейным ужином. Маленький праздник, который всем поднял настроение.",
    ...
    {
        "title": "Выходные на Волге и даче",
        "text": "На даче в этом году особенно красиво: яблони, костёр, чай в термосе и долгие разговоры до темноты.",
    ...
    {
        "title": "Дачное утро у озера",
        "text": "Проснулись рано и ушли к воде. Тишина, птицы и лучший завтрак на природе.",
